angular.module('math.controllers', ['ngAnimate'])
    .controller('GameCtrl', function ($rootScope,$scope) {
        // Debug
        $scope.currentPlatformVersion = ionic.Platform.version();
    })
    .controller('MathMainCtrl', function ($rootScope, $scope, $localStorage, $filter, $cordovaAppRate, $location, SemiSound, SemiGC) {
    ...
    .controller('MathFooterCtrl', function ($scope,$location) {
        $scope.credit = function () {
            $location.path('math/credit');
        };
    })
    .controller('MathGameOverCtrl', function ($rootScope, $scope,$location, $localStorage, Semi,$cordovaScreenshot,SemiSound,$cordovaSocialSharing, SemiGC, $timeout) {
