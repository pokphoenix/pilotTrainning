angular.module('geomath.controllers', ['ngAnimate'])
    .controller('GeoMathCtrl', function ($rootScope,$scope) {
        // Debug
        $scope.currentPlatformVersion = ionic.Platform.version();
    })
    .controller('GeoMathMainCtrl', function ($rootScope, $scope, $localStorage, $filter, $cordovaAppRate, $location, SemiSound, SemiGC) {
    ...
    .controller('GeoMathFooterCtrl', function ($scope,$location) {
        $scope.credit = function () {
            $location.path('geomath/credit');
        };
    })
    .controller('GeoMathGameOverCtrl', function ($rootScope, $scope,$location, $localStorage, Semi,$cordovaScreenshot,SemiSound,$cordovaSocialSharing, SemiGC, $timeout) {
