angular.module('georemember.controllers', ['ngAnimate'])
    .controller('GeoRememberCtrl', function ($rootScope,$scope) {
        // Debug
        $scope.currentPlatformVersion = ionic.Platform.version();
    })
    .controller('GeoRememberMainCtrl', function ($rootScope, $scope, $localStorage, $filter, $cordovaAppRate, $location, SemiSound, SemiGC) {
    ...
    .controller('GeoRememberFooterCtrl', function ($scope,$location) {
        $scope.credit = function () {
            $location.path('geomath/credit');
        };
    })
    .controller('GeoRememberGameOverCtrl', function ($rootScope, $scope,$location, $localStorage, Semi,$cordovaScreenshot,SemiSound,$cordovaSocialSharing, SemiGC, $timeout) {
